...
function SidebarAuth() {
    ...
    return(
        ...
        <div className="header">
                <Link to="/domov2"><img id="logo-home" alt="" src={LP}></img></Link>
                <Link to="/domov2"><p className="dom">domov</p></Link>
                <Link to="/kontakt2"><p className="kon">kontakt</p></Link>
                <Link to="/popis2"><p className="pop">popis</p></Link>
                <Popup trigger=
                ...
                <Link to="/domov2-eng"><img id="brit" alt="" src={BRIT}></img></Link>
            ...
            <div id="sidebarmenu">
                ...
                <Link to="/karty2"><img id="cardb" alt="" src={CM}></img></Link>
                <Link to="/klasika2"><img id="cardb2" alt="" src={CM2}></img></Link>
            </div>
        </div>
