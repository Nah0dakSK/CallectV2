        ...
        <>
            <div className="pps">
                ...
                <h1 className="abaut">POPIS</h1>
                    ...
                    <Link to="/popis-blackjack2"><img id="bj-pps" alt="" src={BJ}></img></Link>
                    <Link to="/popis-poker2"><img id="pk-pps" alt="" src={PK}></img></Link>
                    <Link to="/popis-solitaire2"><img id="pk-pps" alt="" src={SLT}></img></Link>
                    <Link to="/popis-piskvorky2"><img id="pk-pps" alt="" src={PIS}></img></Link>
                    <Link to="/popis-2048-2"><img id="pk-pps" alt="" src={GM}></img></Link>
