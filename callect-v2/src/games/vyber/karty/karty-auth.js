    ...
    return(
        <>
            <div className="krty">
                ...
                <Link to="/blackjack2"><img id="bj-ik" alt="" src={BJ}></img></Link>
                <Link to="/poker2"><img id="pk-ik" alt="" src={PK}></img></Link>
                <Link to="/solitaire2"><img id="slt-ik" alt="" src={SLT}></img></Link>
