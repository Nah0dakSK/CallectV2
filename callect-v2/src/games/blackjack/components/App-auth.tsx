...
import "./App.css";
import Btmlst from './btmlst.js';
import Status from './Status.tsx';
import Controls from './Controls.tsx';
import Hand from './Hand.tsx';
import jsonData from '../deck.json';
import SidebarAuth from '../../../comp/sidebar/sideBarauth.js';
...
const App: React.FC = () => {
  ...
  enum Message {
    bet = 'Stavte si!',
    hitStand = 'Ostať či pokračovať?',
    bust = 'F!',
    userWin = 'Ty si vyhral!',
    dealerWin = 'Dealer vyhral!',
    tie = 'Remíza!'
  }
  ...
  return (
    <>
      ...
      <Hand title={`TY (${userScore})`} cards={userCards} />
      <div><Btmlst/></div>
      </div>
    </>
  );
