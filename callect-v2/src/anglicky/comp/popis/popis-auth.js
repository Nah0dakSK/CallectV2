...
export default function PopisAuth() {
    return(
        <>
            <div className="pps">
                <SidebarAuth/>
                ...
                <h1 className="abaut">ABOUT</h1>
                    ...
                    <Link to="/popis-blackjack2-eng"><img id="bj-pps" alt="" src={BJ}></img></Link>
                    <Link to="/popis-poker2-eng"><img id="pk-pps" alt="" src={PK}></img></Link>
                    <Link to="/popis-solitaire2-eng"><img id="pk-pps" alt="" src={SLT}></img></Link>
                    <Link to="/popis-piskvorky2-eng"><img id="pk-pps" alt="" src={PIS}></img></Link>
                    <Link to="/popis-2048-2-eng"><img id="pk-pps" alt="" src={GM}></img></Link>
