    ...
    return(
        <>
            <div className="krty">
                ...
                <Link to="/blackjack-eng"><img id="bj-ik" alt="" src={BJ}></img></Link>
                <Link to="/poker-eng"><img id="pk-ik" alt="" src={PK}></img></Link>
                <Link to="/solitaire-eng"><img id="slt-ik" alt="" src={SLT}></img></Link>
